...
{
    [TestClass]
    public class VariableTests : ClassTests<Variable<string>>
    {
        ...
        public void ConstructorTest()
        {
            ...
            if (memberInfo != null) Assert.AreEqual(memberInfo.BaseType, typeof(Operand));
        }

        [TestMethod]
        public void IsOperandTest()
        {
            Assert.IsFalse(obj.IsOperand());
        }
        ...
        {
            Assert.AreEqual(0, Variable<string>.Equal);
        }

        [TestMethod]
        public void LessTest()
        {
            Assert.AreEqual(-1, Variable<string>.Less);
        }

        [TestMethod]
        public void GreaterTest()
        {
            Assert.AreEqual(1, Variable<string>.Greater);
        }
