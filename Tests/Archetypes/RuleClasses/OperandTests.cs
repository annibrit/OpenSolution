...
{
    [TestClass]
    public class OperandTests : CommonTests<Operand>
    {
        protected override Operand GetRandomObj()
        {
        ...
        [TestMethod]
        public void ToIntegerVariableTest()
        {
            var name = GetRandom.String();
        ...
        [TestMethod]
        public void ToBooleanVariableTest()
        {
            var name = GetRandom.String();
        ...
        [TestMethod]
        public void ToDoubleVariableTest()
        {
            var name = GetRandom.String();
            var value = GetRandom.String();
            var a = Operand.ToVariable(name, value) as StringVariable;
        ...
        [TestMethod]
        public void ToDecimalVariableTest()
        {
            var name = GetRandom.String();
        ...
        [TestMethod]
        public void ToDateTimeVariableTest()
        {
            var name = GetRandom.String();
        ...
        [TestMethod]
        public void GetRandomInheritedTest()
        {
