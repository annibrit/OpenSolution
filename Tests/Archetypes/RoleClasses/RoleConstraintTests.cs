...
{
    [TestClass]
    public class RoleConstraintTests : CommonTests<RoleConstraint>
    {
        protected override RoleConstraint GetRandomObj()
        {
            return RoleConstraint.Random();
        }

        [TestMethod]
        public void ValidPerformerTypeIdTest()
        {
        ...
        [TestMethod]
        public void ValidPerformerTypeTest()
        {
