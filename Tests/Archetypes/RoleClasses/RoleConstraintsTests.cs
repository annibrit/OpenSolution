...
{
    [TestClass]
    public class RoleConstraintsTests : CommonTests<RoleConstraints>
    {
        protected override RoleConstraints GetRandomObj()
        {
            return RoleConstraints.Random();
        }

        [TestMethod]
        public void GetTypeConstraintsTest()
        {
