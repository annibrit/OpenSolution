...
{
    [TestClass]
    public class RelationshipsTests : CommonTests<Relationships>
    {
        protected override Relationships GetRandomObj()
        {
            return Relationships.Random();
        }
        ...
        [TestMethod]
        public void GetProviderRelationshipsTest()
        {
            var s = GetRandom.String();
        ...
        [TestMethod]
        public void GetConsumerRelationshipsTest()
        {
            var s = GetRandom.String();
