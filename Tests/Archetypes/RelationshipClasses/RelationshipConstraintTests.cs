...
{
    [TestClass]
    public class RelationshipConstraintTests : CommonTests<RelationshipConstraint>
    {
        ...
        [TestMethod]
        public void ValidConsumerRoleTypeTest()
        {
        ...
        [TestMethod]
        public void ValidProviderRoleTypeTest()
        {
        ...
        [TestMethod]
        public void ValidConsumerRoleTypeIdTest()
        {
            Obj = new RelationshipConstraint();
        ...
        [TestMethod]
        public void ValidProviderRoleTypeIdTest()
        {
            Obj = new RelationshipConstraint();
