...
{
    [TestClass]
    public class IntervalTests : CommonTests<Interval<int>>
    {
        [TestInitialize]
        ...
        [TestMethod]
        public void FromIsLessThanToTest()
        {
        ...
        [TestMethod]
        public void ToIsGreaterThanFromTest()
        {
            Assert.AreEqual(int.MinValue, Obj.From);
            Assert.AreEqual(int.MaxValue, Obj.To);
            Obj.From = 0;
        ...
        [TestMethod]
        public void FromAndToCanBeEqualTest()
        {
            Assert.AreEqual(int.MinValue, Obj.From);
            Assert.AreEqual(int.MaxValue, Obj.To);
            Obj.From = 0;
