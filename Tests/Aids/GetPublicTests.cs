...
namespace Open.Tests.Aids
{
    ...
    [TestClass]
    public class GetPublicTests : ClassTests<GetPublic>
    {
        private static readonly BindingFlags p = BindingFlags.Public;
        private static readonly BindingFlags i = BindingFlags.Instance;
        private static readonly BindingFlags s = BindingFlags.Static;
        private static readonly BindingFlags d = BindingFlags.DeclaredOnly;
